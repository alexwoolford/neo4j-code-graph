...
NOTE: If you previously used GraphCodeBERT, re‑compute embeddings and rebuild the vector index before comparing results; vector spaces are not interchangeable.
