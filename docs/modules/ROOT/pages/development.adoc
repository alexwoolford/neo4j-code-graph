...
Many default knobs live in `src/constants.py` (batching, PageRank iterations, CVE settings, etc.). These are sensible defaults that can be overridden in two ways:
