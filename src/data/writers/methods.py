        ...
        for method in file_data["methods"]:
            ...
            method_node = {
                ...
                **(
                ...
                "is_protected": method.get("is_protected", False),
                "is_synchronized": method.get("is_synchronized", False),
                "is_default": method.get("is_default", False),
                "is_package_private": method.get("is_package_private", False),
        ...
        session.run(
            (
                ...
                + """
                    ...
                    m.is_protected = method.is_protected,
...
def create_method_calls(session: Any, files_data: list[dict[str, Any]]) -> None:
                ...
                method_call_rels.append(
                    {
                        ...
                        "callee_name": call.get("method_name"),
    ...
    if method_call_rels:
        ...
        if other_calls:
            ...
            # Allow name-only resolution when uniquely resolvable within file or by caller class
            filtered_calls = other_calls
